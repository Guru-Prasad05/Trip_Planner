...
export function WhatsAppFloat() {
  const href = `https://wa.me/${siteConfig.contact.whatsapp}?text=${encodeURIComponent(
    "Hi! I'd like to plan a trip with Trip Planner.",
  )}`;
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[--shadow-warm] transition-transform hover:scale-110"
    >
